...
/**
 * Manager and Salesman Pages
 */
Route::get('/', [
'before' => "logged:/login,has_perm:_manager,_salesman",
        'uses'   => 'LaravelAcl\Authentication\Controllers\UserdashController@index',
]);
Route::resource('/supply', 'LaravelAcl\Authentication\Controllers\SupplyController');
Route::resource('/spares', 'LaravelAcl\Authentication\Controllers\SparesController');
Route::resource('/cars', 'LaravelAcl\Authentication\Controllers\CarsController');
Route::get('/invenorylist', 'LaravelAcl\Authentication\Controllers\UserdashController@invenorylist');
Route::resource('/sparedetail', 'LaravelAcl\Authentication\Controllers\UserdashController@sparedetail');
Route::resource('/order', 'LaravelAcl\Authentication\Controllers\OrderController');
...
/*
Route::get('/user/signup-success', function () {
